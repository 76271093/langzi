var GLOBAL = this, JSLoader = function(config) {
  ...
  // domutils.isIOS=function(){return false;};
  // domutils.isAndroid=function(){return false;};
  // console.log(JSON.stringify(domutils.Browser));
  domutils.Browser={"name":"chrome","version":49,"Platform":{"name":"win","version":"other","win":true},"chrome":true,"chrome49":true,"Lang":"zh-cn"}
